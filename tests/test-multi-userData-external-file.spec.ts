...
// Read user data from JSON file outside the test suite
...
test.describe('DemoQA Text Box Form Tests', () => {
  // Run the test for each user in the data file
  usersData.forEach((userData, index) => {
    test(`should fill form and verify submitted data for user ${index + 1}: ${userData.name}`, async ({ page }) => {
